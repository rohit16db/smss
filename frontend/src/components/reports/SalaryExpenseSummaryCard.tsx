...
interface SalaryExpenseSummaryCardProps {
  title: string;
  amount: number;
  icon?: LucideIcon;
  trend?: number;
...
/**
 * Card component for displaying salary expense metrics
 */
export const SalaryExpenseSummaryCard: React.FC<SalaryExpenseSummaryCardProps> = ({
  title,
  amount,
  icon: Icon,
  trend,
