...
public class TeacherAssignmentConfiguration : IEntityTypeConfiguration<TeacherAssignment>
{
    public void Configure(EntityTypeBuilder<TeacherAssignment> builder)
    {
        ...
        // Unique constraint: No duplicate active assignments for same (teacher, class, subject)
        builder.HasIndex(ta => new { ta.TeacherId, ta.ClassId, ta.SubjectId, ta.RemovalDate })
            .IsUnique()
