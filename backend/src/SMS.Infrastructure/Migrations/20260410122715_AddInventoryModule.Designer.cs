...
namespace SMS.Infrastructure.Migrations
{
    ...
    [Migration("20260410122715_AddInventoryModule")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SMS.Domain.Entities.InventoryCategory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SMS.Domain.Entities.InventoryItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SMS.Domain.Entities.InventoryTransaction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SMS.Domain.Entities.NotificationHistory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SMS.Domain.Entities.NotificationTemplate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SMS.Domain.Entities.StaffAssignment", b =>
                {
                    ...
                    b.HasIndex("StaffId", "SectionId", "SubjectId", "RemovalDate")
                        .IsUnique()
            ...
            modelBuilder.Entity("SMS.Domain.Entities.StudentTransportAssignment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SMS.Domain.Entities.TimetableEntry", b =>
                {
                    ...
                    b.HasIndex("AcademicYearId", "TimeSlotId", "StaffAssignmentId")
                        .IsUnique();
            ...
            modelBuilder.Entity("SMS.Domain.Entities.Vehicle", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SMS.Domain.Entities.InventoryItem", b =>
                {
                    b.HasOne("SMS.Domain.Entities.InventoryCategory", "Category")
                        .WithMany()
            ...
            modelBuilder.Entity("SMS.Domain.Entities.InventoryTransaction", b =>
                {
                    b.HasOne("SMS.Domain.Entities.InventoryItem", "Item")
                        .WithMany()
            ...
            modelBuilder.Entity("SMS.Domain.Entities.NotificationHistory", b =>
                {
                    b.HasOne("SMS.Domain.Entities.NotificationTemplate", "Template")
                        .WithMany()
            ...
            modelBuilder.Entity("SMS.Domain.Entities.RouteStop", b =>
                {
                    b.HasOne("SMS.Domain.Entities.TransportRoute", "Route")
                        .WithMany("Stops")
            ...
            modelBuilder.Entity("SMS.Domain.Entities.TimetableEntry", b =>
                {
                    ...
                    b.HasOne("SMS.Domain.Entities.StaffAssignment", "StaffAssignment")
                        .WithMany()
            ...
            modelBuilder.Entity("SMS.Domain.Entities.TransportRoute", b =>
                {
                    b.HasOne("SMS.Domain.Entities.Vehicle", "Vehicle")
                        .WithMany("Routes")
